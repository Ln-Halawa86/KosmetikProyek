...
import type { BookingFormData, CartItem } from "../types/type";
import { paymentSchema } from "../types/validationBooking";
import AccordingSection from "../components/AccordingSection";

type FormData = {
  proof: File | null;
  cosmetic_ids: { id: number; quantity: number }[]; // Updated to include quantity
};
...
export default function PaymentPage() {
  ...
  // State to hold the uploaded file name
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-[640px] flex-col gap-5 bg-[#F6F6F8] pb-[30px]">
      ...
      <AccordingSection title="Payment Details" subTitle="Sebelum bayar cek lagi" iconSrc="/assets/images/icons/information.svg">
      ...
      {/* // Trusted E-Wallets Accordion Section */}
      <AccordingSection title="Trusted E-Wallets" subTitle="Choose lorem dolor active" iconSrc="/assets/images/icons/wallet.svg">
      ...
      {/* // Bank Transfer Accordion Section */}
      <AccordingSection title="Bank Transfer" subTitle="Choose lorem dolor active" iconSrc="/assets/images/icons/banktf.svg">
        ...
        <section id="PaymentConfirmation">
          <div className="flex flex-col gap-5 rounded-3xl bg-white px-[14px] py-5">
            ...
            <label className="flex flex-col gap-[6px]">
              ...
              {/* // Display validation error for proof of payment */}
            ...
            <button type="submit" disabled={loading} className="flex w-full items-center justify-between rounded-full bg-cosmetics-gradient-pink-white px-5 py-[14px] transition-all duration-300 hover:shadow-[0px_6px_22px_0px_#FF4D9E82]">
